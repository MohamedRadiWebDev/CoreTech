...
const Footer = () => {
  ...
  const { data: socialLinks } = useQuery<SocialLinks>({
    queryKey: ['/data/social-links.json'],
    initialData: {
      facebook: "#",
      instagram: "#",
      twitter: "#",
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <div className="text-2xl font-bold text-white mb-6">
              {siteConfig?.company.name || "كور تك"}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:contact@coretech.com" className="text-gray-400 hover:text-white transition-colors">
                  contact@coretech.com
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href="https://wa.me/+201126923449" className="text-gray-400 hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 mb-4 md:mb-0">
              &copy; {currentYear} Core Tech. {t("footer.all_rights_reserved")}
            </p>
