    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <motion.div 
            className="bg-gray-50 dark:bg-gray-800 rounded-xl p-8 animate-on-scroll"
          ...
          >
            <h3 className="text-2xl font-bold mb-6">{t("contact.get_in_touch")}</h3>
            ...
            <div className="mt-12 p-6 bg-green-50 dark:bg-green-900/20 rounded-xl border border-green-200 dark:border-green-800 flex items-center">
