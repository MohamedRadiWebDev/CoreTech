...
const Testimonials = () => {
  ...
  useEffect(() => {
    ...
    fetch('/data/testimonials.json')
      .then(response => response.json())
      .then(data => {
        const translatedTestimonials = data.map((testimonial: Testimonial) => ({
          ...testimonial,
          name: t(`testimonials.${testimonial.id}_name`),
          role: t(`testimonials.${testimonial.id}_role`),
          text: t(`testimonials.${testimonial.id}_text`),
          projectName: t(`testimonials.${testimonial.id}_project`)
        }));
      ...
      <main className="pt-32 pb-20 min-h-screen" data-rtl={isRTL}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {testimonials.length > 0 ? (
                ...
                >
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h4 className="text-lg font-bold">{testimonial.name}</h4>
                      <p className="text-gray-600 dark:text-gray-400">{testimonial.role}</p>
                      <p className="text-sm text-primary-600 dark:text-primary-400">{testimonial.projectName}</p>
                    </div>
                  </div>
                  <div className="mb-4">
                    <div className="flex text-yellow-400 mb-2">
              ...
              <div className="col-span-3 text-center py-12">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  يرجى الانتظار بينما نقوم بتحميل الشهادات
                </p>
              </div>
            )}
          </motion.div>
          ...
          <div className="mt-16 bg-gray-100 dark:bg-gray-800 rounded-xl p-8 text-center">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 max-w-3xl mx-auto">
              انضم إلى عملائنا الراضين واكتشف كيف يمكننا مساعدة عملك على النمو
            </p>
            <Link href="/contact">
