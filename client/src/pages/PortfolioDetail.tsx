...
export default function PortfolioDetail() {
  ...
  return (
    <>
      <SeoHead title={project.seoTitle || project.title} description={project.seoDescription || project.shortDescription} canonicalPath={path} image={project.image.startsWith('http') ? project.image : `https://coretech.com${project.image}`} jsonLd={[breadcrumbSchema([{ name: t('nav.home'), path: '/' }, { name: t('nav.portfolio'), path: '/portfolio' }, { name: project.title, path }]), projectSchema({ title: project.title, description: project.shortDescription, image: project.image, category: project.categoryName, path })]} />
